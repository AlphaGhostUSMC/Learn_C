...
// if: This executes the body of bracketed code starting with statement1 if  evaluates to true.
...
// if - else: This executes the body of bracketed code starting with statement1 if  evaluates to true, or it executes the body of code starting with statement2 if  evaluates to false. Note that only one of the bracketed code sections will ever be executed.
...
int main()
{
  ...
  if (n < 1 || n > 9) { printf("Greater than 9"); }
  else {
    switch (n) {
